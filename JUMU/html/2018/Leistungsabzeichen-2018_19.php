...
<head>
    <title>JUMU 2000 - Leistungsabzeichen 2018/19</title>
    <meta charset="utf-8">
...
<!-- Navigation Left -->
    ...
    <div uk-scrollspy="target: > div; cls:uk-animation-scale-up; delay: 100">
        <div>
            <h1>Leistungsabzeichen - 2018/19</h1>
        </div>
    </div>
    <br>
    <br>
                ...
                <div uk-scrollspy="target: > div; cls:uk-animation-slide-left-medium; delay: 900">
                    <div>
                        <ul class="uk-breadcrumb">
                            ...
                            <li><span>Leistungsabzeichen - 2018/19</span></li>
                        </ul>
                    </div>
                </div>
                <hr>
        ...
        <div>
            <div class="galerie2">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/Leistungsabzeichen2018_19";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/Leistungsabzeichen2018_19/$file'><img src='../../images/Leistungsabzeichen2018_19/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
