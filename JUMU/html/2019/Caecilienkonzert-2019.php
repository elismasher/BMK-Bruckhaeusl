...
<head>
    <title>JUMU 2000 - Cäcilienkonzert - 2019</title>
    <meta charset="utf-8">
                ...
                <div uk-scrollspy="target: > div; cls:uk-animation-slide-left-medium; delay: 900">
                    <div>
                        <ul class="uk-breadcrumb">
                            ...
                            <li><span>Cäcilienkonzert - 2019</span></li>
                        </ul>
                    </div>
                </div>
                <hr>
        ...
        <div>
            <div class="galerie2">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/Caecilienkonzert2019";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/Caecilienkonzert2019/$file'><img src='../../images/Caecilienkonzert2019/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
