...
<head>
    <title>BMK Bruckhäusl - Stockschießen 2020</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div uk-scrollspy="target: > div; cls:uk-animation-scale-up; delay: 100">
        <div>
            <h1>Stockschießen Bruckhäusl</h1>
        </div>
    </div>
    <br>
    <br>
                ...
                <div uk-scrollspy="target: > div; cls:uk-animation-slide-left-medium; delay: 900">
                    <div>
                        <ul class="uk-breadcrumb">
                            ...
                            <li><span>Stockschießen Bruckhäusl</span></li>
                        </ul>
                    </div>
                </div>
                <hr>
        ...
        <div>
            <div class="galerie">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/Stockschiessen2020/";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/Stockschiessen2020/$file'><img src='../../images/Stockschiessen2020/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
