...
<head>
    <title>BMK Bruckhäusl - 40 Jahre Holzmeisterkirche</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div uk-scrollspy="target: > div; cls:uk-animation-scale-up; delay: 100">
        <div>
            <h1>40 Jahre Holzmeisterkirche</h1>
        </div>
    </div>
    <br>
    <br>
                ...
                <div uk-scrollspy="target: > div; cls:uk-animation-slide-left-medium; delay: 900">
                    <div>
                        <ul class="uk-breadcrumb">
                            ...
                            <li><span>40 Jahre Holzmeisterkirche</span></li>
                        </ul>
                    </div>
                </div>
                <hr>
        ...
        <div>
            <div class="galerie">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/40 JahreHolzmeisterkirche2018/";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/40 JahreHolzmeisterkirche2018/$file'><img src='../../images/40 JahreHolzmeisterkirche2018/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
