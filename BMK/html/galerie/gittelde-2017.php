...
<head>
    <title>BMK Bruckhäusl - Gittelde 2017</title>
    <meta charset="utf-8">
        ...
        <div>
            <div class="galerie">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/Gittelde2017/";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/Gittelde2017/$file'><img src='../../images/Gittelde2017/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
