...
<head>
    <title>BMK Bruckhäusl - Frühjahrskonzert 2020</title>
    <meta charset="utf-8">
    ...
    <div uk-scrollspy="target: > div; cls:uk-animation-fade; delay: 900">
        <div>
            <div style="margin-left: 8%; margin-right: 8%;">
                ...
                <div uk-scrollspy="target: > div; cls:uk-animation-slide-left-medium; delay: 900">
                    <div>
                        <ul class="uk-breadcrumb">
                            ...
                            <li><a href="../galerie2020.html">2020</a></li>
                            <li><span>Frühjahrskonzert</span></li>
                        </ul>
                    </div>
                </div>
                <hr>
                ...
                <div uk-grid>
                    <div>
                        <iframe width="320" height="180" src="https://www.youtube.com/embed/V0ZS7xXC_MA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div>
                        <iframe width="320" height="180" src="https://www.youtube.com/embed/A2y_gon1A0M" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                </div>
        ...
        <div>
            <div class="galerie">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/Fruehjahrskonzert2020/";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/Fruehjahrskonzert2020/$file'><img src='../../images/Fruehjahrskonzert2020/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
