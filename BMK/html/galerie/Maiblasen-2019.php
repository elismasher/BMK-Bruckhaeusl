...
<head>
    <title>BMK Bruckhäusl - Maiblasen 2019</title>
    <meta charset="utf-8">
        ...
        <div>
            <div class="galerie">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/Maiblasen2019/";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/Maiblasen2019/$file'><img src='../../images/Maiblasen2019/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
