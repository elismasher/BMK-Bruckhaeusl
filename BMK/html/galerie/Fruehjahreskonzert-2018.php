...
<head>
    <title>BMK Bruckhäusl - Frühjahrskonzert 2018</title>
    <meta charset="utf-8">
    ...
    <div uk-scrollspy="target: > div; cls:uk-animation-fade; delay: 900">
        <div>
            <div style="margin-left: 8%; margin-right: 8%;">
                ...
                <div uk-grid>
                    <div>
                        <iframe width="320" height="180" src="https://www.youtube.com/embed/ywyBuz8C2jM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div></div>
                </div>
        ...
        <div>
            <div class="galerie">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/Fruehjahreskonzert2018/";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/Fruehjahreskonzert2018/$file'><img src='../../images/Fruehjahreskonzert2018/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
