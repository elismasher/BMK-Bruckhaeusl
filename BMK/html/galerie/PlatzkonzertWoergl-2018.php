...
<head>
    <title>BMK Bruckhäusl - Platzkonzert Wörgl 2018</title>
    <meta charset="utf-8">
                ...
                <div uk-scrollspy="target: > div; cls:uk-animation-slide-left-medium; delay: 900">
                    <div>
                        <ul class="uk-breadcrumb">
                            ...
                            <li><span>Platzkonzert Wörgl</span></li>
                        </ul>
                    </div>
                </div>
                <hr>
        ...
        <div>
            <div class="galerie">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/PlatzkonzertWoergl2018/";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/PlatzkonzertWoergl2018/$file'><img src='../../images/PlatzkonzertWoergl2018/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
