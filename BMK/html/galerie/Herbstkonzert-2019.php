...
<head>
    <title>BMK Bruckhäusl - Herbstkonzert 2019</title>
    <meta charset="utf-8">
    ...
    <div uk-scrollspy="target: > div; cls:uk-animation-fade; delay: 900">
        <div>
            <div style="margin-left: 8%; margin-right: 8%;">
                ...
                <div uk-grid>
                    <div>
                        <iframe width="320" height="180" src="https://www.youtube.com/embed/9PjRA4LsuC0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div></div>
                </div>
        ...
        <div>
            <div class="galerie">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/Herbstkonzert2019/";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/Herbstkonzert2019/$file'><img src='../../images/Herbstkonzert2019/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
