...
<head>
    <title>BMK Bruckhäusl - Maiblasen 2018</title>
    <meta charset="utf-8">
        ...
        <div>
            <div class="galerie">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/Maiblasen2018/";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/Maiblasen2018/$file'><img src='../../images/Maiblasen2018/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
