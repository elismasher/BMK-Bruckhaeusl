...
<head>
    <title>BMK Bruckhäusl - Heldenehrung 2018</title>
    <meta charset="utf-8">
        ...
        <div>
            <div class="galerie">
                <div uk-lightbox="animation: fade">
                    ...
                    <?php
			$dir = "../../images/Heldenehrung2018/";
			$i = 0;
			if (is_dir($dir)) {
			    if ($dh = opendir($dir)) {
				while ((($file = readdir($dh)) !== false)) {
                    if( $file != "." && $file != ".."){
				        echo"<a href='../../images/Heldenehrung2018/$file'><img src='../../images/Heldenehrung2018/$file' width='300px' height='auto'></a>";
                    }
				  }
				closedir($dh);
			    }
